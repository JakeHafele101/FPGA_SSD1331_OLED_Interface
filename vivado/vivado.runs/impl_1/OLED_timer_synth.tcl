...
namespace eval ::optrace {
  variable script "C:/Projects/FPGA_SSD1331_OLED_Interface/vivado/vivado.runs/impl_1/OLED_timer_synth.tcl"
...
set rc [catch {
  ...
  open_checkpoint OLED_timer_synth_routed.dcp
  set_property webtalk.parent_dir C:/Projects/FPGA_SSD1331_OLED_Interface/vivado/vivado.cache/wt [current_project]
set_property TOP OLED_timer_synth [current_fileset]
OPTRACE "read constraints: write_bitstream" START { }
OPTRACE "read constraints: write_bitstream" END { }
  catch { write_mem_info -force -no_partial_mmi OLED_timer_synth.mmi }
OPTRACE "write_bitstream setup" END { }
OPTRACE "write_bitstream" START { }
  write_bitstream -force OLED_timer_synth.bit 
OPTRACE "write_bitstream" END { }
OPTRACE "write_bitstream misc" START { }
OPTRACE "read constraints: write_bitstream_post" START { }
OPTRACE "read constraints: write_bitstream_post" END { }
  catch {write_debug_probes -quiet -force OLED_timer_synth}
  catch {file copy -force OLED_timer_synth.ltx debug_nets.ltx}
