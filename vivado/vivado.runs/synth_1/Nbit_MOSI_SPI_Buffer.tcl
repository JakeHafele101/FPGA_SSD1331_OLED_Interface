...
namespace eval ::optrace {
  variable script "C:/Projects/FPGA_SSD1331_OLED_Interface/vivado/vivado.runs/synth_1/Nbit_MOSI_SPI_Buffer.tcl"
...
read_verilog -library xil_defaultlib C:/Projects/FPGA_SSD1331_OLED_Interface/src/Nbit_MOSI_SPI_Buffer.v
...
synth_design -top Nbit_MOSI_SPI_Buffer -part xc7a35tcpg236-1
...
write_checkpoint -force -noxdef Nbit_MOSI_SPI_Buffer.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file Nbit_MOSI_SPI_Buffer_utilization_synth.rpt -pb Nbit_MOSI_SPI_Buffer_utilization_synth.pb"
